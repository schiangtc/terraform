...
//
//     import oauthserver "github.com/schiangtc/terraform/command/testdata/login-oauth-server"
...
import (
	...
	oauthserver "github.com/schiangtc/terraform/command/testdata/login-oauth-server"
)
