...
import (
	...
	backendAtlas "github.com/truecar-ops/terraform/backend/atlas"
	backendLocal "github.com/truecar-ops/terraform/backend/local"
	backendRemote "github.com/truecar-ops/terraform/backend/remote"
	backendArtifactory "github.com/truecar-ops/terraform/backend/remote-state/artifactory"
	backendAzure "github.com/truecar-ops/terraform/backend/remote-state/azure"
	backendConsul "github.com/truecar-ops/terraform/backend/remote-state/consul"
	backendCos "github.com/truecar-ops/terraform/backend/remote-state/cos"
	backendEtcdv2 "github.com/truecar-ops/terraform/backend/remote-state/etcdv2"
	backendEtcdv3 "github.com/truecar-ops/terraform/backend/remote-state/etcdv3"
	backendGCS "github.com/truecar-ops/terraform/backend/remote-state/gcs"
	backendHTTP "github.com/truecar-ops/terraform/backend/remote-state/http"
	backendInmem "github.com/truecar-ops/terraform/backend/remote-state/inmem"
	backendKubernetes "github.com/truecar-ops/terraform/backend/remote-state/kubernetes"
	backendManta "github.com/truecar-ops/terraform/backend/remote-state/manta"
	backendOSS "github.com/truecar-ops/terraform/backend/remote-state/oss"
	backendPg "github.com/truecar-ops/terraform/backend/remote-state/pg"
	backendS3 "github.com/truecar-ops/terraform/backend/remote-state/s3"
	backendSwift "github.com/truecar-ops/terraform/backend/remote-state/swift"
)
