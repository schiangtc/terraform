...
import (
	...
	backendAtlas "github.com/schiangtc/terraform/backend/atlas"
	backendLocal "github.com/schiangtc/terraform/backend/local"
	backendRemote "github.com/schiangtc/terraform/backend/remote"
	backendArtifactory "github.com/schiangtc/terraform/backend/remote-state/artifactory"
	backendAzure "github.com/schiangtc/terraform/backend/remote-state/azure"
	backendConsul "github.com/schiangtc/terraform/backend/remote-state/consul"
	backendCos "github.com/schiangtc/terraform/backend/remote-state/cos"
	backendEtcdv2 "github.com/schiangtc/terraform/backend/remote-state/etcdv2"
	backendEtcdv3 "github.com/schiangtc/terraform/backend/remote-state/etcdv3"
	backendGCS "github.com/schiangtc/terraform/backend/remote-state/gcs"
	backendHTTP "github.com/schiangtc/terraform/backend/remote-state/http"
	backendInmem "github.com/schiangtc/terraform/backend/remote-state/inmem"
	backendKubernetes "github.com/schiangtc/terraform/backend/remote-state/kubernetes"
	backendManta "github.com/schiangtc/terraform/backend/remote-state/manta"
	backendOSS "github.com/schiangtc/terraform/backend/remote-state/oss"
	backendPg "github.com/schiangtc/terraform/backend/remote-state/pg"
	backendS3 "github.com/schiangtc/terraform/backend/remote-state/s3"
	backendSwift "github.com/schiangtc/terraform/backend/remote-state/swift"
)
